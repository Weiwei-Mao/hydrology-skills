...
**针对用户方向：** 水文学研究、SWAT/MODFLOW 数值模型、数据分析、机器学习、写论文、写项目
...
| **matlab** | ★★★★☆ | MATLAB 和 GNU Octave 数值计算，用于矩阵运算、数据分析、可视化和科学计算。**SWAT/MODFLOW 常用** |
...
| 技能名 | 推荐度 | 中文名称/描述 |
|--------|--------|--------------|
| **networkx** | ★★★★☆ | 用于在 Python 中创建、分析和可视化复杂网络和图形的综合工具包。**处理河流网络、流域拓扑结构必备** |
...
| **pymc-bayesian-modeling** | ★★★★☆ | 使用 PyMC 进行贝叶斯建模。构建层次模型、MCMC(NUTS)、变分推断、LOO/WAIC 比较。**贝叶斯水文建模很有用** |
...
*文档生成时间: 2026-02-01*
*针对用户：水文学研究、SWAT/MODFLOW数值模型、数据分析、机器学习*
*保留技能数: 58（已删除 82 个生物医学类技能）*
